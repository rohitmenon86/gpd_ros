...
void getPointCloud()
{
    ...
    { 
        ...
        else
        {
            ...
            view_points = myParam.camera_position;
        ...
        if(has_cloud){
            ...
            if (input == 'y')
            {
                ...
                else
                {
                    ...
                    // detect grasps
                    detector->preprocessPointCloud(*cloudPtr);
...
void configCallback(gpd_ros::detect_graspsConfig &config, uint32_t level)
{
    ...
    myParam.workspace.assign({config.groups.workspace.i0, 
                            config.groups.workspace.i1, 
                            config.groups.workspace.i2, 
                            config.groups.workspace.i3, 
                            config.groups.workspace.i4, 
                            config.groups.workspace.i5});
